...
/**
 * "Write an application with a combo box containing three items labeled "Red", "Green", and "Blue"
 * that change the background color of a panel in the center of the frame to red, green, or blue."
 */

public class Programming_Exercise_11_5 extends JFrame {
    ...
    private Programming_Exercise_11_5() {
        this.colorChooser=new CustomCombobox();
    ...
    class ColorChanger implements ActionListener {
        ...
        public void actionPerformed(ActionEvent event) {
            ...
            switch (color) {
                case "Red":
                    Programming_Exercise_11_5.this.backgroundColor = Color.RED;
                    break;
                case "Green":
                    Programming_Exercise_11_5.this.backgroundColor = Color.GREEN;
                    break;
                case "Blue":
                    Programming_Exercise_11_5.this.backgroundColor = Color.BLUE;
                    break;
            }
            Programming_Exercise_11_5.this.centerPanel.setBackground(Programming_Exercise_11_5.this.backgroundColor);
        }
    }
    ...
    private void createButtonPanel() {
        ...
        panelArray[0][0].add(colorChooser);
    }
    ...
    public static void main(String[] args) {
        ...
        JFrame frame = new Programming_Exercise_11_5();
